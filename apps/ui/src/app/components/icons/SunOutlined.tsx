...
// Sun icon by Icons8: https://icons8.com/icon/set/sun/material-outlined--static
const SunSvg = () => (
...
export const SunOutlined = (props: Partial<CustomIconComponentProps>) => <Icon component={SunSvg} {...props} />
