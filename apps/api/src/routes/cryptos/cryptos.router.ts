...
import { deleteCryptoController, getCryptoByIdController, getCryptoPriceHistoryController, getCryptosController, postCryptoController } from './cryptos.controller';
